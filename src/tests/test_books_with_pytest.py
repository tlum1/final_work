...
async def test_create_book(db_session, async_client):
    # прежде чем создавать книгу, создадим ее продавца. Создаем вручную, чтобы случайно не поломаться на методе POST
    seller = entities.Seller(first_name="Vasya", last_name="Onegin", email="123@email.com," , password="password123123")
